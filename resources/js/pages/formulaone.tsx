...
const FormulaOneData: React.FC = () => {
            ...
            .map((col) => ({
                ...
                cell: (info) => {
                    if (col.toLowerCase().includes('headshot')) {
                        ...
                        if (!url) return null;
                        return (
                            <img src={url} alt={col} className="h-12 w-12 rounded-md border object-cover" style={{ minWidth: 32, minHeight: 32 }} />
                        );
                    }
    ...
    function isColumnWithAccessorKey(col: ColumnDef<Record<string, unknown>>): col is ColumnDef<Record<string, unknown>> & {
        accessorKey: string;
    } {
        return typeof (col as unknown as { accessorKey?: unknown }).accessorKey === 'string';
    }

    const visibleColumns = columns.filter(isColumnWithAccessorKey).map((col) => col.accessorKey);
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Formula One Data', href: '/formulaone' }]}>
            ...
            <div className="p-4">
                <h1 className="mb-4 text-2xl font-bold">Formula One Data</h1>
                <div className="mb-4 flex gap-2">
                    {endpoints.map((tab) => (
                        <button
                            key={tab.key}
                            className={`rounded px-4 py-2 ${activeTab === tab.key ? 'bg-neutral-800 text-white dark:bg-neutral-200 dark:text-black' : 'bg-neutral-200 text-black dark:bg-neutral-800 dark:text-white'}`}
                            onClick={() => {
                    ...
                    <div className="overflow-x-auto">
                                    ...
                                    <tr key={headerGroup.id}>
                                        {headerGroup.headers.map((header) => {
                                            ...
                                            return (
                                                <th
                                                    key={header.id}
                                                    className={`min-w-[60px] border bg-neutral-100 px-3 py-2 text-left font-semibold dark:bg-neutral-800 ${isIdCol ? 'max-w-[60px] text-center' : 'max-w-[180px]'} truncate`}
                                                >
                                                    <div className="flex flex-col gap-1">
                                                        <div
                                                            className={`flex items-center gap-1 select-none ${isIdCol ? 'justify-center' : ''}`}
                                        ...
                                        <th className="min-w-[80px] border bg-neutral-100 px-3 py-2 text-left font-semibold dark:bg-neutral-800">
                                            Actions
                                        </th>
                                    </tr>
                                ))}
                                        ...
                                        >
                                            {row.getVisibleCells().map((cell) => {
                                                ...
                                                const isDate =
                                                    ...
                                                    cell.column.id.toLowerCase().includes('date_start') ||
                                                    cell.column.id.toLowerCase().includes('date_end');
                                                return (
                                                    <td
                                                        key={cell.id}
                                                        className={`border px-3 py-2 align-top ${
                                                            isIdCol
                                                                ? 'max-w-[60px] min-w-[60px] text-center'
                                                                : isDriverNumber
                                                                  ? 'max-w-[60px] min-w-[32px] text-center'
                                                                  : isDate
                                                                    ? 'max-w-[120px] min-w-[80px] text-center'
                                                                    : isRecording
                                            ...
                                            {/* Actions */}
                                            <td className="min-w-[80px] border px-3 py-2 align-top">
                                                <Button
                                                    size="sm"
                                                    variant="outline"
                                                    className="mr-2"
                        ...
                        <div className="mt-4 flex flex-wrap items-center justify-between gap-2">
                            <div className="flex items-center gap-2">
                                <button
                                    className="rounded border bg-neutral-100 px-3 py-1 dark:bg-neutral-800"
                ...
                <Dialog open={modalOpen} onOpenChange={setModalOpen}>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>
                                {modalMode === 'create'
                                    ? `Add ${endpoints.find((e) => e.key === activeTab)?.label}`
                                    : `Edit ${endpoints.find((e) => e.key === activeTab)?.label}`}
                            </DialogTitle>
                        </DialogHeader>
                        <form
                        ...
                        >
                            ...
                            {activeTab === 'meetings' ? (
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="meeting_key">
                                            Meeting Key<span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            id="meeting_key"
                                            name="meeting_key"
                                    ...
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="meeting_name">
                                        ...
                                        <input
                                            ...
                                            name="meeting_name"
                                            type="text"
                                            defaultValue={String(modalInitial?.meeting_name ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="meeting_official_name">
                                            Official Name
                                        </label>
                                        <input
                                            id="meeting_official_name"
                                            name="meeting_official_name"
                                            type="text"
                                            defaultValue={String(modalInitial?.meeting_official_name ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="circuit_short_name">
                                            Circuit Short Name
                                        </label>
                                        <input
                                            ...
                                            type="text"
                                            defaultValue={String(modalInitial?.circuit_short_name ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="country_code">
                                        ...
                                        <input
                                            ...
                                            name="country_code"
                                            type="text"
                                            defaultValue={String(modalInitial?.country_code ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="country_name">
                                        ...
                                        <input
                                            ...
                                            name="country_name"
                                            type="text"
                                            defaultValue={String(modalInitial?.country_name ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            name="location"
                                            type="text"
                                            defaultValue={String(modalInitial?.location ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="circuit_key">
                                            Circuit Key<span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            id="circuit_key"
                                            name="circuit_key"
                                            type="number"
                                            min={1}
                                            defaultValue={String(modalInitial?.circuit_key ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="country_key">
                                            Country Key<span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            id="country_key"
                                            name="country_key"
                                            type="number"
                                            min={1}
                                            defaultValue={String(modalInitial?.country_key ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="date_start">
                                        ...
                                        <input
                                            ...
                                            name="date_start"
                                            type="datetime-local"
                                            defaultValue={String(modalInitial?.date_start ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="gmt_offset">
                                            GMT Offset
                                        </label>
                                        <input
                                            id="gmt_offset"
                                            name="gmt_offset"
                                            type="text"
                                            defaultValue={String(modalInitial?.gmt_offset ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="year">
                                        ...
                                        <input
                                            ...
                                            min={1900}
                                            max={2100}
                                            defaultValue={String(modalInitial?.year ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="session_id">
                                        ...
                                        <input
                                            ...
                                            name="session_id"
                                            type="text"
                                            defaultValue={String(modalInitial?.session_id ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="session_name">
                                        ...
                                        <input
                                            ...
                                            name="session_name"
                                            type="text"
                                            defaultValue={String(modalInitial?.session_name ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="session_type">
                                        ...
                                        <input
                                            ...
                                            name="session_type"
                                            type="text"
                                            defaultValue={String(modalInitial?.session_type ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="meeting_id">
                                        ...
                                        >
                                            ...
                                            {meetingsList.map((m) => (
                                                <option key={m.meeting_key} value={String(m.meeting_key)}>
                                                    {m.meeting_name ?? m.meeting_official_name ?? m.name ?? m.meeting_key}
                                                </option>
                                            ))}
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="circuit_short_name">
                                            Circuit Short Name<span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            id="circuit_short_name"
                                            name="circuit_short_name"
                                    ...
                                    <div>
                                        <label className="mb-1 block text-sm font-medium" htmlFor="date_end">
                                        ...
                                        <input
                                            ...
                                            name="date_end"
                                            type="datetime-local"
                                            defaultValue={String(modalInitial?.date_end ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        <label htmlFor="team_radio_id">
                                            Team Radio ID<span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            id="team_radio_id"
                                            name="team_radio_id"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            defaultValue={String(modalInitial?.session_key ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            type="number"
                                            placeholder="e.g. 44"
                                            defaultValue={String(modalInitial?.driver_number ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            name="date"
                                            type="datetime-local"
                                            defaultValue={String(modalInitial?.date ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            defaultValue={String(modalInitial?.recording_url ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        <label htmlFor="weather_id">
                                            Weather ID<span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            id="weather_id"
                                            name="weather_id"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            defaultValue={String(modalInitial?.air_temperature ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            step="any"
                                            placeholder="e.g. 60"
                                            defaultValue={String(modalInitial?.humidity ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            defaultValue={String(modalInitial?.pressure ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div className="mt-2 flex items-center gap-2">
                                        <input id="is_raining" name="is_raining" type="checkbox" className="mr-2" />
                                        <label htmlFor="is_raining" className="mb-0">
                                            Is Raining?
                                        </label>
                                    </div>
                                    <div id="rainfall-group" style={{ display: 'none' }}>
                                        ...
                                        <input
                                            ...
                                            step="any"
                                            placeholder="e.g. 2.5"
                                            defaultValue={String(modalInitial?.rainfall ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            defaultValue={String(modalInitial?.track_temperature ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <select id="wind_direction_select" className="w-1/2 rounded border px-3 py-2">
                                            ...
                                            <input
                                                ...
                                                defaultValue={String(modalInitial?.wind_direction ?? '')}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            defaultValue={String(modalInitial?.wind_speed ?? '')}
                                            className="w-full rounded border px-3 py-2"
                                        />
                                    </div>
                                </div>
                                ...
                                visibleColumns
                                    ...
                                    .map((col) => {
                                        ...
                                        return (
                                            <div key={col}>
                                                <label className="mb-1 block text-sm font-medium capitalize" htmlFor={col}>
                                                    {col.replace(/_/g, ' ')}
